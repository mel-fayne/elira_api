...
class Student(models.Model):
    ...
    favourite_flavour = models.CharField(max_length=50, null=True)
    childhod_nickname = models.CharField(max_length=50, null=True)
    first_phone = models.CharField(max_length=50, null=True)
